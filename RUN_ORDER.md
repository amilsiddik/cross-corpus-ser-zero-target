...
Do not use the old sequence folders:

- `processed_intra_sequence_features_base`
- `results_lodo_sequence_cross_attention_base`
- `/content/drive/MyDrive/New Jurnal Cross/newcode/...`
